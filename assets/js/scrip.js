...
//     { id: 14, title: "Mixed Pizza", image: "./assets/images/steak-pizza.jpg", price: 140000, count: 1, categoryName: "Pizza" },
//     { id: 15, title: "Sicilian Pizza", image: "./assets/images/پیتزا-سیسیلی.jpg", price: 250000, count: 1, categoryName: "Pizza" },
//     { id: 16, title: "Pepperoni Pizza", image: "./assets/images/3-1.jpg", price: 180000, count: 1, categoryName: "Pizza" },   // اصلاح شد
...
//             } else {
//                 let filtered = productsArray.filter(p => p.categoryName === cat);
//                 renderPaginationProducts(filtered)
//             }
//         });
//     });
...
//     userBasket.forEach(product => total += product.price * product.count);

//     totalAverageBasket.innerHTML = "$ " + total;
// }
...
//     userBasket.forEach(product => total += product.count);

//     totalQuantityBasket.innerHTML = total;
// }
...
//     const pageItems = productsArray.slice(firstPageIndex, lastPageIndex);

//     allProducts(pageItems);
// }
